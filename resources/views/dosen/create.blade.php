...
@section('title', 'Tambah Penugasan Dosen')

@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('dosen.index') }}">Kelola Dosen</a></li>
<li class="breadcrumb-item active">Tambah Penugasan</li>
@endsection
...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            <div class="card-header bg-white">
                <h5 class="mb-0 fw-bold">Tambah Penugasan Dosen</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('dosen.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="status_dosen" id="status_dosen" class="form-select @error('status_dosen') is-invalid @enderror" required>
                            ...
                            <option value="Penanggung Jawab" {{ old('status_dosen') == 'Penanggung Jawab' ? 'selected' : '' }}>Penanggung Jawab</option>
                            <option value="Pengampu" {{ old('status_dosen') == 'Pengampu' ? 'selected' : '' }}>Pengampu</option>
                        </select>
                        @error('status_dosen')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="lokasi" id="lokasi" class="form-control @error('lokasi') is-invalid @enderror"
                               placeholder="Contoh: Ruang 101, Lab A, etc" value="{{ old('lokasi') }}" required>
                        @error('lokasi')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
    ...
    <div class="col-md-4">
        <div class="alert alert-info">
            ...
            <p class="small mb-0">
                Gunakan form ini untuk menugaskan dosen ke mata kuliah tertentu.
                Setiap pasangan (dosen, mata kuliah) hanya dapat ditugaskan satu kali.
            </p>
        </div>
    </div>
</div>
